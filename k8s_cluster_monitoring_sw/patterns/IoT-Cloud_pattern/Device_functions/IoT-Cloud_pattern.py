...
#    edgex.createDevice("Device%d") % (device_cnt)
    edgex.createDevice("Device%d" % (i))
#    device_name.append("Device%d") % (device_cnt)
    device_name.append("Device%d" % (i))
print(device_name)
...
while True:
    for i in range(0, device_cnt):
        ...
        if t <= 35:
            ...
            payload = {"origin": 1471806386919, "device": 'Device'+str(i),
                       "readings": [{"origin": 1471806386919, "name": "device", "value": 'Device'+str(i)},
            ...
            time.sleep(0.5)  ##delay time 100 seconds
